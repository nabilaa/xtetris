...
//	
	public void turun() {
		if ( X1[0] < 17 && X2[0] < 17 && X3[0] < 17 && X4[0] < 17 && bisaTurun(X1, X2, X3, X4) ) {
			...
			board[X1[0]][X1[1]].setBackgroundColor(Color.WHITE);
			board[X2[0]][X2[1]].setBackgroundColor(Color.WHITE);
			board[X3[0]][X3[1]].setBackgroundColor(Color.WHITE);
			board[X4[0]][X4[1]].setBackgroundColor(Color.WHITE);
			X1[0]++;
			X2[0]++;
			X3[0]++;
			X4[0]++;
			...
			board[X1[0]][X1[1]].setBackgroundColor(Color.CYAN);
			board[X2[0]][X2[1]].setBackgroundColor(Color.CYAN);
			board[X3[0]][X3[1]].setBackgroundColor(Color.CYAN);
			board[X4[0]][X4[1]].setBackgroundColor(Color.CYAN);
		}
		...
		for (int i = 0; i < 18; i++) {
			for (int j = 0; j < 9; j++) {
				if(bayangan[i][j] == 0){
					...
					//board[i][j].setBackgroundColor(Color.parseColor("#ffcccc"));
				} else {
					board[i][j].setBackgroundColor(Color.CYAN);
				}
			}
		}
	}
